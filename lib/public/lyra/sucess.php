...
/**
 *     	\file       htdocs/public/lyra/success.php
 *		\ingroup    lyra
 */
...
$welcomeTitle = make_substitutions($langs->transnoentities('LYRA_FORM_WELCOME_TITLE'), $substit);
$msg = make_substitutions($langs->transnoentities('LYRA_PAYMENT_ACCEPTED'), $substit);
/*
 * View
 */
...
print '<tr class="liste_total"><td align="left" colspan="2">'.$langs->trans("ThankYouForYourPayment").'</td></tr>'."\n";

//print '<tr><td align="left" colspan="2">'.$langs->trans("ThankYouForYourPayment").' :</td></tr>'."\n";
